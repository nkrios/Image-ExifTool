...
images.
  ...
  0x927c   MakerNoteCanon            ExifIFD    Canon
           ...
           MakerNoteKodak8           ExifIFD    Kodak Type8
...
=head2 Nikon Tags
  ...
  0x0091   ShotInfo0208                         Nikon ShotInfo0208
           ShotInfo0209                         Nikon ShotInfo0209
...
=head3 Nikon ShotInfo0208 Tags

These tags are extracted from encrypted data in D80 images.

  Tag ID   Tag Name                             Writable
  ------   --------                             --------
  0x0000   ShotInfoVersion                      N
  0x024a   ShutterCount                         int32u
  590.1    Rotation                             Y
  590.2    VibrationReduction                   Y
  590.3    FlashFired                           Y
  748.1    Beep                                 Y
  748.2    AFAssist                             Y
  748.3    NoMemoryCard                         Y
  748.4    ImageReview                          Y
  748.5    Illumination                         Y
  748.6    MainDialExposureComp                 Y
  748.7    EVStepSize                           Y
  749.1    AutoISO                              Y
  749.2    AutoISOMax                           Y
  749.3    AutoISOMinShutterSpeed               Y
  750.1    AutoBracketMode                      Y
  750.2    AutoBracketOrder                     Y
  751.1    MonitorOffTime                       Y
  751.2    MeteringTime                         Y
  751.3    SelfTimerTime                        Y
  752.1    AELockButton                         Y
  752.2    AELock                               Y
  752.3    RemoteOnDuration                     Y
  753.1    CommandDials                         Y
  753.2    FunctionButton                       Y
  754.1    GridDisplay                          Y
  754.2    ViewfinderWarning                    Y
  754.3    CenterWeightedAreaSize               Y
  754.4    ExposureDelayMode                    Y
  754.5    MB-D80Batteries                      Y
  755.1    FlashShutterSpeed                    Y
  755.2    AutoFP                               Y
  755.3    ModelingFlash                        Y
  756.1    InternalFlash                        Y
  756.2    ManualFlashOutput                    Y
  757.1    RepeatingFlashOutput                 Y
  757.2    RepeatingFlashCount                  Y
  758.1    RepeatingFlashRate                   Y
  758.2    CommanderChannel                     Y
  759.1    CommanderInternalFlash               Y
  759.2    CommanderGroupAMode                  Y
  759.3    CommanderGroupBMode                  Y
  760.1    CommanderInternalTTLComp             Y
  760.2    CommanderInternalManualOutput        Y
  761.1    CommanderGroupA_TTL-AAComp           Y
  761.2    CommanderGroupA_ManualOutput         Y
  762.1    CommanderGroupB_TTL-AAComp           Y
  762.2    CommanderGroupB_ManualOutput         Y
  763.1    CenterAFArea                         Y
  763.2    FocusAreaSelection                   Y
  763.3    AFAreaIllumination                   Y
  0x02fc   AFAreaMode                           Y

=head3 Nikon ShotInfo0209 Tags
...
These tags are extracted from encrypted data in D40 and D40X images.
  ...
  ------   --------                             --------
  0x0000   ShotInfoVersion                      N
  0x0246   ShutterCount                         int32u
  586.1    VibrationReduction                   Y
  729.1    Beep                                 Y
  729.2    AFAssist                             Y
  729.3    NoMemoryCard                         Y
  729.4    ImageReview                          Y
  730.1    AutoISO                              Y
  730.2    AutoISOMax                           Y
  730.3    AutoISOMinShutterSpeed               Y
  0x02db   ImageReviewTime                      Y
  732.1    MonitorOffTime                       Y
  732.2    MeteringTime                         Y
  732.3    SelfTimerTime                        Y
  733.1    RemoteOnDuration                     Y
  733.2    AELockButton                         Y
  733.3    AELock                               Y
  734.1    ShootingModeSetting                  Y
  734.2    TimerFunctionButton                  Y
  0x02df   Metering                             Y
  737.1    InternalFlash                        Y
  737.2    ManualFlashOutput                    Y
  0x02e2   FlashLevel                           int8s
  0x02e3   FocusModeSetting                     Y
  0x02e4   AFAreaModeSetting                    Y
...
=head3 Pentax AEInfo Tags
   ...
   -----   --------                             --------
     ...
     14    FlashExposureCompUsed                int8s
...
=head3 Pentax LensInfo Tags
   ...
   -----   --------                             --------
      0    LensType                             N
      4    LensCodes                            int8u[16]~
      5    LensCodes                            int8u[16]~
