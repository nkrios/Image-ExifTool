...
Format).
   ...
   -----   --------                             --------
     ...
     15    BitsPerSample                        N
     16    Compression                          N
     17    ResolutionUnits                      N
     18    YResolution                          N
     22    XResolution                          N

=head3 JPEG APP14 Tags
...
The Pentax tags are also used in Asahi cameras.
  ...
  0x0018   ExposureBracketStep                  int16
  0x0019   WhiteBalance                         int16u
