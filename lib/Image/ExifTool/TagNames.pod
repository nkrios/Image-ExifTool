...
default B<Group> listed below is used unless another group is specified.
  ...
  0x013d   Predictor                 -          N
  0x013e   WhitePoint                IFD0       rational32u
  0x013f   PrimaryChromaticities     IFD0       rational32u
  0x0140   ColorMap                  -          N
  0x0141   HalftoneHints             IFD0       int16u
  0x0142   TileWidth                 -          N
  0x0143   TileLength                -          N
  ...
  0xa214   SubjectLocation           ExifIFD    int16u
  ...
  0xc61d   WhiteLevel                -          N
  0xc61e   DefaultScale              IFD0       rational32u
  0xc61f   DefaultCropOrigin         IFD0       int32u
  0xc620   DefaultCropSize           IFD0       int32u
  ...
  0xc630   DNGLensInfo               IFD0       rational32u
...
=head2 IPTC EnvelopeRecord Tags
  ...
  ------   --------                             --------
  0x0000   EnvelopeRecordVersion                int16u
  0x0005   Destination                          string[0,1024]
  0x0014   FileFormat                           int16u
  0x0016   FileVersion                          int16u
  ...
  0x0078   ARMIdentifier                        int16u
  0x007a   ARMVersion                           int16u

=head2 IPTC ApplicationRecord Tags

  Tag ID   Tag Name                             Writable
  ------   --------                             --------
  0x0000   ApplicationRecordVersion             int16u
  ...
  0x00c8   ObjectPreviewFileFormat              int16u
  0x00c9   ObjectPreviewFileVersion             int16u
...
=head2 IPTC NewsPhoto Tags
  ...
  Tag ID   Tag Name                             Writable
  ------   --------                             --------
  0x0000   NewsPhotoVersion                     int16u
  0x000a   IPTCPictureNumber                    string[0,16]
  0x0014   IPTCImageWidth                       int16u
  0x001e   IPTCImageHeight                      int16u
  0x0028   IPTCPixelWidth                       int16u
  0x0032   IPTCPixelHeight                      int16u
  0x0037   SupplementalType                     int8u
  0x003c   ColorRepresentation                  int8u
  0x0040   InterchangeColorSpace                int8u
  0x0041   ColorSequence                        int8u
  0x0054   NumIndexEntries                      int16u
  0x0056   IPTCBitsPerSample                    int8u
  0x005a   SampleStructure                      int8u
  0x0064   ScanningDirection                    int8u
  0x0066   IPTCImageRotation                    int8u
  0x006e   DataCompressionMethod                int8u
  0x0078   QuantizationMethod                   int8u
  0x007d   EndPoints                            int8u
  0x0082   ExcursionTolerance                   int8u
  0x0087   BitsPerComponent                     int8u
