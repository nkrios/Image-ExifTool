...
images.
  ...
  0x927c   MakerNoteCanon            ExifIFD    Canon
           ...
           MakerNoteKodakIFD         ExifIFD    Kodak IFD
...
=head2 Nikon Tags
  ...
  0x00a8   FlashInfo                            Nikon FlashInfo
...
=head3 Nikon PictureControl Tags
   ...
   Index   Tag Name                             Writable
   -----   --------                             --------
      0    PictureControlVersion                undef[4]
...
currently writable because the information is encrypted.
   ...
   -----   --------                             --------
    ...
    586    ShutterCount                         N
  590.1    Rotation                             N
  590.2    VibrationReduction                   N
  590.3    FlashFired                           N
  748.1    Beep                                 N
  748.2    AFAssist                             N
  748.3    NoMemoryCard                         N
  748.4    ImageReview                          N
  748.5    EVStepSize                           N
  748.6    MainDialExposureComp                 N
  748.7    Illumination                         N
  749.1    AutoISO                              N
  749.2    AutoISOMax                           N
  749.3    AutoISOMinShutterSpeed               N
  750.1    AutoBracketMode                      N
  750.2    AutoBracketOrder                     N
  751.1    MonitorOffTime                       N
  751.2    MeteringTime                         N
  751.3    SelfTimerTime                        N
  752.1    AELockButton                         N
  752.2    AELock                               N
  752.3    RemoteOnDuration                     N
  753.1    CommandDials                         N
  753.2    FunctionButton                       N
  754.1    GridDisplay                          N
  754.2    ViewfinderWarning                    N
  754.3    CenterWeightedAreaSize               N
  754.4    ExposureDelayMode                    N
  754.5    MB-D80Batteries                      N
  755.1    FlashShutterSpeed                    N
  755.2    AutoFP                               N
  755.3    ModelingFlash                        N
  756.1    InternalFlash                        N
  756.2    ManualFlashOutput                    N
  757.1    RepeatingFlashOutput                 N
  757.2    RepeatingFlashCount                  N
  758.1    RepeatingFlashRate                   N
  758.2    CommanderChannel                     N
  759.1    CommanderInternalFlash               N
  759.2    CommanderGroupAMode                  N
  759.3    CommanderGroupBMode                  N
  760.1    CommanderInternalTTLComp             N
  760.2    CommanderInternalManualOutput        N
  761.1    CommanderGroupA_TTL-AAComp           N
  761.2    CommanderGroupA_ManualOutput         N
  762.1    CommanderGroupB_TTL-AAComp           N
  762.2    CommanderGroupB_ManualOutput         N
  763.1    CenterAFArea                         N
  763.2    FocusAreaSelection                   N
  763.3    AFAreaIllumination                   N
    764    AFAreaMode                           N
...
only valid for specific versions.
   ...
   -----   --------                             --------
    ...
    117    VibrationReduction                   N
    130    VibrationReduction                   N
    343    ShutterCount                         N
    430    VibrationReduction                   N
...
=head3 Nikon FlashInfo Tags

   Index   Tag Name                             Writable
   -----   --------                             --------
      0    FlashInfoVersion                     string[4]
...
The Pentax tags are also used in Asahi cameras.
  ...
  0x0205   ShotInfo                             Pentax ShotInfo
