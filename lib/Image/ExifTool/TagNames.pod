...
default B<Group> listed below is used unless another group is specified.
  ...
  0x0102   BitsPerSample             IFD0       int16u[3]~
  ...
  0x9101   ComponentsConfiguration   ExifIFD    N~
  ...
  0x9214   SubjectLocation           ExifIFD    int16u[2]
  ...
  0x927c   MakerNoteCanon            ExifIFD    Canon
           ...
           MakerNoteCasioEX-Z3       ExifIFD    Casio Type2
           MakerNoteFujiFilm         ExifIFD    FujiFilm
           MakerNoteKodak            ExifIFD    Kodak
           MakerNoteKodak1           ExifIFD    Kodak
           ...
           MakerNoteRicoh2           ExifIFD    Ricoh TextMakerNote
  ...
  0x9c9b   XPTitle                   ExifIFD    int8u
  0x9c9c   XPComment                 ExifIFD    int8u
  0x9c9d   XPAuthor                  ExifIFD    int8u
  0x9c9e   XPKeywords                ExifIFD    int8u
  0x9c9f   XPSubject                 ExifIFD    int8u
...
=head2 IPTC EnvelopeRecord Tags
...
=head2 IPTC ApplicationRecord Tags
  ...
  ------   --------                             --------
     ...
     35    ReleaseTime                          digits[11]
     37    ExpirationDate                       digits[8]
     38    ExpirationTime                       digits[11]
     ...
     60    TimeCreated                          digits[11]
     62    DigitalCreationDate                  digits[8]
     63    DigitalCreationTime                  digits[11]
...
=head2 IPTC ObjectData Tags

  Tag ID   Tag Name                             Writable
  ------   --------                             --------
     10    SubFile                              N

=head2 IPTC PostObjectData Tags
...
=head2 ICC_Profile Chromaticity Tags
...
=head2 ICC_Profile ColorantTable Tags
...
=head2 ICC_Profile Measurement Tags
...
=head2 ICC_Profile ViewingConditions Tags
...
=head2 Canon CameraSettings Tags
...
=head2 CanonCustom Functions10D Tags
...
=head2 CanonCustom Functions20D Tags
...
=head2 CanonCustom Functions Tags
...
=head2 CanonCustom Functions1D Tags
...
=head2 Canon FileInfo Tags

   Index   Tag Name                             Writable
   -----   --------                             --------
      1    FileNumber                           int32u

=head2 Canon ColorInfo Tags

   Index   Tag Name                             Writable
   -----   --------                             --------
      9    ColorTemperature                     int16s

=head2 Canon WhiteBalance Tags
...
=head2 Canon PreviewImageInfo Tags
...
=head2 Casio Type2 Tags

  Tag ID   Tag Name                             Writable
  ------   --------                             --------
  0x0002   PreviewImageSize                     N
  0x0003   CasioPreviewLength                   N
...
These tags used by a number of CX, DC, DX and LS models.
   ...
   -----   --------                             --------
     ...
     30    Aperture                             int16u
     32    KodakExposure?                       int32u
     36    ExposureBias                         int16s
     ...
     96    ISOUsed                              int16u
     98    TotalZoomFactor                      int16u
    100    DateTimeStamp                        int16u
    102    ColorMode                            int16u
    104    DigitalZoomFactor                    int16u
    107    Sharpness                            int8s

=head2 Kodak Type2 Tags
...
These tags used by the CX4200.
   ...
   -----   --------                             --------
     ...
     30    ISOUsed                              int16u
     32    TotalZoomFactor                      int16u
     34    DigitalZoomFactor                    int16u
     39    FlashMode                            int8u
     42    ImageRotated                         int8u
     43    Macro                                int8u

=head2 Kodak Unknown Tags
...
=head2 Minolta CameraSettings Tags
   ...
   -----   --------                             --------
      ...
      8    MinoltaISO                           N
      9    MinoltaShutterSpeed                  N
     10    MinoltaAperture                      N
     11    MacroMode                            int32u
...
=head2 Nikon Tags
  ...
  0x0012   FlashExposureComp                    N
  0x0013   ISOSetting                           int16u[2]
  0x0016   ImageBoundary                        Y
  0x0018   FlashExposureBracketValue            N
  0x0019   ExposureBracketValue                 N
  ...
  0x0097   ColorBalanceD70                      Nikon ColorBalanceD70
           ColorBalanceD2H                      Nikon ColorBalanceD2H
...
=head2 Nikon ColorBalanceD70 Tags
...
=head2 Nikon ColorBalanceD2H Tags
...
=head2 Nikon ColorBalanceD100 Tags
...
=head2 Nikon NikonCaptureOffsets Tags
...
and Agfa cameras.
  ...
  0x0100   ThumbnailImage                       Y
  0x0101   ColorMode                            Y
  0x0102   MinoltaQuality                       Y
  0x0103   MinoltaQuality                       Y
  0x0200   SpecialMode                          N
  0x0201   Quality                              int16u
  0x0202   Macro                                int16u
  0x0204   DigitalZoom                          rational32u
  0x0207   FirmwareVersion                      Y
  0x0208   PictureInfo                          Y
  ...
  0x100d   Zoom                                 Y
  0x100e   MacroFocus                           Y
  0x100f   SharpnessFactor                      Y
  0x1011   ColorMatrix                          Y
  0x1012   BlackLevel                           Y
  ...
  0x1023   FlashBias                            Y
  0x1029   Contrast                             Y
  0x102a   SharpnessFactor                      Y
  0x102b   ColorControl                         Y
  0x102c   ValidBits                            Y
  0x102d   CoringFilter                         Y
  0x102e   OlympusImageWidth                    Y
  0x102f   OlympusImageHeight                   Y
  0x1034   CompressionRatio                     Y
  0x2010   Equipment                            Olympus Equipment
  0x2020   CameraSettings                       Olympus CameraSettings
  0x2030   Subdir3                              Olympus Subdir3
  0x2040   ImageProcessing                      Olympus ImageProcessing
  0x2050   FocusInfo                            Olympus FocusInfo

=head2 Olympus Equipment Tags

  Tag ID   Tag Name                             Writable
  ------   --------                             --------
  0x0000   EquipmentVersion                     Y
  0x0100   FirmwareVersion2                     Y
  0x0101   SerialNumber                         Y
  0x0202   LensSerialNumber                     Y
  0x0206   MaxApertureAtMaxFocal                Y
  0x0207   MinFocalLength                       Y
  0x0208   MaxFocalLength                       Y
  0x0302   ExtenderSerialNumber                 Y
  0x1003   FlashSerialNumber                    Y

=head2 Olympus CameraSettings Tags

  Tag ID   Tag Name                             Writable
  ------   --------                             --------
  0x0000   CameraSettingsVersion                Y
  0x0101   PreviewImageStart                    int32u*
  0x0102   PreviewImageLength                   int32u*
  0x0200   ExposureMode                         Y
  0x0202   MeteringMode                         Y
  0x0301   ContinuousAutoFocus                  N
  0x0304   AFAreas                              N
  0x0501   WhiteBalanceTemperature              Y
  0x0502   WhiteBalanceBracket                  Y
  0x0503   CustomSaturation                     N
  0x0504   ModifiedSaturation                   Y
  0x0505   ContrastSetting                      Y
  0x0506   SharpnessSetting                     Y
  0x0507   ColorSpace                           Y
  0x050a   NoiseFilter                          Y
  0x050c   ShadingCompensation                  Y
  0x050d   CompressionFactor                    Y
  0x0600   Sequence                             N
  0x0603   ImageQuality2                        Y

=head2 Olympus Subdir3 Tags

  Tag ID   Tag Name                             Writable
  ------   --------                             --------
  0x0000   Subdir3Version                       Y

=head2 Olympus ImageProcessing Tags

  Tag ID   Tag Name                             Writable
  ------   --------                             --------
  0x0000   ImageProcessingVersion               Y
  0x0300   SmoothingParameter1                  Y
  0x0310   SmoothingParameter2                  Y
  0x0600   SmoothingThresholds                  Y
  0x0610   SmoothingThreshold2                  Y
  0x0614   OlympusImageWidth2                   Y
  0x0615   OlympusImageHeight2                  Y
  0x1010   NoiseFilter2                         Y
  0x1012   ShadingCompensation2                 Y

=head2 Olympus FocusInfo Tags

  Tag ID   Tag Name                             Writable
  ------   --------                             --------
  0x0000   FocusInfoVersion                     Y
  0x0209   AutoFocus                            Y
...
The Pentax tags are also used in Asahi cameras.
  ...
  0x0019   WhiteBalance                         int16u
  0x001a   WhiteBalanceMode                     Y
  0x001d   FocalLength                          int32u
  0x001e   DigitalZoom                          int16u
  0x001f   Saturation                           int16u
  0x0020   Contrast                             int16u
  0x0021   Sharpness                            int16u
  0x0029   FrameNumber                          Y
  0x0039   RawImageSize                         N
...
=head2 Ricoh TextMakerNote Tags
...
=head2 Kodak SpecialEffects Tags
...
=head2 CanonRaw SensorInfo Tags
...
=head2 CanonRaw ImageFormat Tags
...
=head2 CanonRaw ExposureInfo Tags
...
=head2 Photoshop JPEG_Quality Tags
...
=head2 Jpeg2000 ImageHeader Tags
...
=head2 Jpeg2000 CaptureResolution Tags
...
=head2 Jpeg2000 DisplayResolution Tags
