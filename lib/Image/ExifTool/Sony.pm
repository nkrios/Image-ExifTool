...
%Image::ExifTool::Sony::Tag9400 = (
    ...
    0x0010 => {
        ...
        PrintConv => {
            0 => 'Single Frame',
            1 => 'Burst', # (RX100 "Continuous - Self-timer")
            2 => 'Continuous - Bracketing', # (RX100)
            3 => 'Continuous - WB Bracketing', # (HX9V) (RX100)
            5 => 'Continuous - Burst', # (HX9V)
            6 => 'Single Frame - Capture During Movie', #PH (RX100)
            # 6 - ReleaseMode3 is Single Frame' (CX130E,CX560E - PH)
            ...
            19 => 'Continuous - Speed Priority', #PH (RX100)
            20 => 'Continuous - Multi Frame NR',
            26 => 'Continuous Shooting', #PH (RX100)
            28 => 'Self-portrait', #PH (RX100)
            29 => 'Speed Priority Continuous',
        },
    },
#    0x0013 => {
#        Name => 'FlashAction_JR',
...
#    },
    0x0022 => {
        ...
        PrintConv => {
            0 => 'Burst', # (RX100 too)
            1 => 'Single Frame',
            2 => 'Continuous - 2 shots', # (Background defocus, 3D Image)
            3 => 'Continuous - 3 shots', # (HDR, WB Bracketing) (RX100, also continuous bracket)
            5 => 'Continuous - 5 shots', # (PH; RX100)
            6 => 'Continuous - 6 shots', # (Multi Frame NR, Anti Motion blur, Hand-held Twilight)
            10 => 'Continuous - Burst', # (HX9V)
...
%Image::ExifTool::Sony::Tag940e = (
    ...
    0x017d => { #PH (verified only for SLT-A77V; likely valid for other SLT models - ref 12)
