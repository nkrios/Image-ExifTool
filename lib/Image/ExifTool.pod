...
Profile and Photoshop IRB meta information from JPEG, JP2, TIFF, PNG, GIF,
THM, CRW (Canon RAW), CR2 (Canon 1D Mk II RAW), MRW (Minolta RAW), NEF
(Nikon Electronic image Format), PEF (Pentax RAW), ORF (Olympus RAW Format)
and DNG (Digital Negative) images, as well as the maker notes of many
digital cameras by various manufacturers including Canon, Casio, FujiFilm,
Kodak, Minolta/Konica-Minolta, Nikon, Olympus/Epson, Panasonic/Leica,
Pentax/Asahi, Ricoh, Sanyo and Sigma/Foveon. It writes EXIF, GPS, IPTC, XMP
and MakerNotes information to JPEG, TIFF, GIF, CRW, THM, CR2, NEF, PEF and
DNG files.
...
as arguments to L</ImageInfo> take precidence over L</Options> settings.
...
Save state of new values to be later restored by L</RestoreNewValues>.
    ...
    $exifTool->WriteInfo('a.jpg');      # write ISO + previous new values
    $exifTool->RestoreNewValues();      # restore previous new values
    $exifTool->WriteInfo('b.jpg');      # write previous new values only
...
Composite, EXIF, ExifTool, File, GPS, GeoTiff, ICC_Profile, IPTC, Jpeg2000,
MakerNotes, PNG, Photoshop, PrintIM, XMP

=item Family 1 (Specific Location):

Canon, CanonCustom, CanonRaw, Casio, Composite, ExifIFD, ExifTool, File,
FujiFilm, GPS, GeoTiff, GlobParamIFD, ICC-chrm, ICC-clrt, ICC-header,
ICC-meas, ICC-view, ICC_Profile, IFD0, IFD1, IPTC, InteropIFD, Jpeg2000,
Kodak, KodakBordersIFD, KodakEffectsIFD, MakerUnknown, Minolta, Nikon,
NikonPreview, Olympus, PNG, Panasonic, Pentax, Photoshop, PrintIM, Ricoh,
Sanyo, Sigma, Sony, SubIFD, XMP, XMP-aux, XMP-crs, XMP-dc, XMP-exif,
XMP-iptcCore, XMP-pdf, XMP-photoshop, XMP-tiff, XMP-xmp, XMP-xmpBJ,
XMP-xmpMM, XMP-xmpRights
