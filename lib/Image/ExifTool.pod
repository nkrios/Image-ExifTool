...
EXIF, IPTC, XMP, GPS, GeoTIFF, ICC Profile and Photoshop IRB meta
information from JPEG, TIFF, GIF, THM, CRW (Canon RAW), CR2 (Canon 1D Mk II
RAW), MRW (Minolta RAW), NEF (Nikon Electronic image Format) and DNG
(Digital Negative) images. ExifTool also reads the maker notes of many
...
a comma-separated string of values is returned for PrintConv, or a reference
to the list of values (in scalar context) or the list itself (in list
context) is returned for ValueConv.
...
Composite, EXIF, ExifTool, File, GPS, GeoTiff, ICC_Profile, IPTC,
...
Copyright 2003-2004, Phil Harvey
