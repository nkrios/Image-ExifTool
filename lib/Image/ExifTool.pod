...
GIF, BMP, PICT, QTIF, PNG, MNG, JNG, MIFF, PGM, PGM, PBM, XMP, EPS, PS, AI,
PDF, PSD, DCM, ACR, THM, CRW (Canon RAW), CR2 (Canon RAW 2), MRW (Minolta
RAW), NEF (Nikon Electronic image Format), PEF (Pentax RAW), ORF (Olympus
RAW Format), RAF (FujiFilm RAW Format), SRF (Sony Raw Format), MOS (Leaf
Mosaic), X3F (Sigma Raw) and DNG (Digital Negative) images, MP3 and WAV
audio files, and AVI, MOV and MP4 videos. ExifTool also extracts information
from the maker notes of many digital cameras by various manufacturers
...
Ricoh, Sanyo and Sigma/Foveon. It writes EXIF, GPS, IPTC, XMP and MakerNotes
information to JPEG, TIFF, GIF, PPM, PGM, PBM, PNG, MNG, JNG, CRW, THM, CR2,
MRW, NEF, PEF, MOS and DNG files.
...
In the case of a list (as can happen with the 'Keywords' tag for instance),
PrintConv returns a comma-separated string of values in scalar context,
while ValueConv returns a reference to an array of values.  In list context,
L</GetValue> returns the list for both PrintConv and ValueConv.  The
...
APP12, BMP, Canon, CanonCustom, CanonRaw, Casio, Composite, DICOM, ExifIFD,
...
ID3v2_4, IFD0, IFD1, IPTC, InteropIFD, JFIF, JVC, Jpeg2000, Kodak,
