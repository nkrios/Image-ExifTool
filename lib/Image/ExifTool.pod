...
ExifTool writes EXIF, GPS, IPTC, XMP, JFIF, MakerNotes, Photoshop IRB and
AFCP meta information to JPEG, TIFF, GIF, PSD, XMP, PPM, PGM, PBM, PNG, MNG,
JNG, CRW, THM, CR2, MRW, NEF, PEF, MOS and DNG images.
...
AFCP, AIFF, APP12, ASF, BMP, Composite, DICOM, DNG, EXIF, ExifTool, File,
...
AFCP, AIFF, APP12, ASF, BMP, Canon, CanonCustom, CanonRaw, Casio, Composite,
