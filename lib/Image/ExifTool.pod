...
Character set for converting XP characters.  Valid values are:
...
tag name of 'All' can be used when deleting tags to delete all tags, or all
tags in a specified group (for family 0 groups only).
